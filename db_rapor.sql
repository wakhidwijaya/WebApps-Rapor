...
-- Database: `db_rapor`
--
CREATE DATABASE IF NOT EXISTS `db_rapor` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `db_rapor`;
...
-- Database: `pmi`
--
CREATE DATABASE IF NOT EXISTS `pmi` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `pmi`;
...
--
-- Table structure for table `Blood Stock`
--

CREATE TABLE `Blood Stock` (
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `id` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `blood_stocks` (`created_at`, `updated_at`, `id`, `name`, `stock`) VALUES
('2019-12-10 09:20:11', '2019-12-10 09:20:11', 1, 'A+', 10),
('2019-12-10 09:20:22', '2019-12-10 09:20:22', 2, 'A-', 10),
('2019-12-10 09:20:30', '2019-12-10 09:20:30', 3, 'B-', 10),
('2019-12-10 09:20:33', '2019-12-10 09:20:33', 4, 'B+', 10);
...
(28, '2019_12_06_081232_articles', 1),
(29, '2019_12_10_150254_Blood Stock', 1),
(30, '2019_12_10_150320_blood_stocks', 1),
(31, '2019_12_10_155838_Patients', 2);
...
--
-- Indexes for table `Blood Stock`
--
ALTER TABLE `Blood Stock`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `Blood Stock`
--
ALTER TABLE `Blood Stock`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
