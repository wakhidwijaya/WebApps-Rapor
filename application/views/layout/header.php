...
<!--		<link rel="shortcut icon" href="--><?php //echo base_url('assets/img/logo.ico');?><!--" type="image/x-icon">-->
		<link href="<?php echo base_url('assets/plugins/touchspin/jquery.bootstrap-touchspin.min.css') ?>" rel="stylesheet" type="text/css" />
...
<body class="hold-transition skin-black sidebar-mini">
	<header class="main-header">
		<a href="<?php echo base_url() ?>" class="logo">
			<span class="logo-mini"><img style="max-height: 40px; padding-top:5px" src="<?php echo base_url('assets/img/logo_2.png') ?>"> </span>
